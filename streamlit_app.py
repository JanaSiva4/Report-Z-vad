                    ...
                    if not reported_by:
                        ...
                        try:
                            ...
                            if r.status_code in [200, 201, 202]:
                                ...
                                st.error(f"❌ Chyba odeslání (status {r.status_code}). Zkontroluj VPN.")
...
# ==================== DASHBOARD ====================
    ...
    m4.markdown(f"<div style='text-align:center;font-size:0.65rem;color:#94a3b8;font-style:italic'>čeká na servis / díl — klikni pro detail</div>", unsafe_allow_html=True)
